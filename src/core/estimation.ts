import { Estimation, Fare, Itinerary, NonEmptyString, PositiveInteger, Route, ServedCity } from "."
...
export const estimateFor = (itinerary: Itinerary.Itinerary): Estimation => {
	...
	const restDistance = itinerary.distance - 1;
	const restDistanceFare = Fare.multiply(restDistance, baseFare)
